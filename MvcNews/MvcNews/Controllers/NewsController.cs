...
namespace MvcNews.Controllers
{
	public class NewsController : Controller
	{
		...
		public async Task<IActionResult> Edit(int id, [Bind("Id,TimeStamp,Text,RowVersion")] NewsItem newsItem)
		{
			...
			if (ModelState.IsValid)
			{
				...
				catch (DbUpdateConcurrencyException e)
				{
					...
					{
						ModelState.AddModelError("", "Action failed. This data has been modified by another user. Try again.");
		...
		[ValidateAntiForgeryToken]
		public async Task<IActionResult> DeleteConfirmed(NewsItem newsItem)
		{
